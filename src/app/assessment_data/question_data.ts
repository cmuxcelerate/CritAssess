	...
	[
		...
		new Question(
			...
			[
				...
				new Answer("Because Solution 1 has a higher score in Requirement 4 than it does in Requirement B", false),
				new Answer("Because Solution 2 has a higher score in Requirement 4 than it does in Requirement C", true),
			],
			// KC's
			[
				"placeholder"
